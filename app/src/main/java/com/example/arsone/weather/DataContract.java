...
public final class DataContract {
    ...
    public static final class CityEntry implements BaseColumns {
        ...
        public static final String COLUMN_CITY_ID = "city_id";             // int/INTEGER

      //  public static final int ID_PATH_POSITION = 0; // id position index in table
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static final String COLUMN_TIMESTAMP    = "dt";            // timestamp in seconds (int/INTEGER)
